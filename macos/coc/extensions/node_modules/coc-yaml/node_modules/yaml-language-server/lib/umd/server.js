(function (factory) {
                ...
                for (const pattern in schemaAssociations) {
                    ...
                    if (Array.isArray(association)) {
                        association.forEach((uri) => {
                            languageSettings = configureSchemas(uri, [pattern], null, languageSettings, yamlLanguageService_1.SchemaPriority.SchemaAssociation);
                        });
                    }
                }
            }
        ...
        if (schemaConfigurationSettings) {
            schemaConfigurationSettings.forEach((schema) => {
                ...
                if (uri) {
                    ...
                    languageSettings = configureSchemas(uri, schema.fileMatch, schema.schema, languageSettings, yamlLanguageService_1.SchemaPriority.Settings);
                }
            });
        }
     ...
     */
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    function configureSchemas(uri, fileMatch, schema, languageSettings, priorityLevel) {
    ...
    connection.onInitialize((params) => {
        ...
        clientFormatterDynamicRegisterSupport = !!(capabilities.textDocument &&
